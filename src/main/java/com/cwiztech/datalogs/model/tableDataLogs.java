...
public class tableDataLogs {
	...
	public static TableDataLog TableSaveDataLog(long tableID, DatabaseTables databaseTableID, LoginUser loginUser,
			String tableData) {
	...
	public static APIRequestDataLog apiRequestDataLog(String requestType, DatabaseTables databaseTableID,
			LoginUser requestID, String path, String input, String workstation) throws JsonProcessingException {
	...
	public static TableDataLog TableSaveDataLog(long contituency_ID, DatabaseTables databaseTableID, long l,
			String rtn) {
		// TODO Auto-generated method stub
		return null;
	}

	public static TableDataLog TableDeleteDataLog(long contituency_ID, DatabaseTables databaseTableID, long user_ID,
			String rtn) {
		// TODO Auto-generated method stub
		return null;
	}
